...
export default function Toprating() {
  ...
  return (
    ...
    <div className=" w-screen p-16 h-[70vh]">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" />
      ...
      >
        {popular.map((pop) => (
          <div onClick={()=>navigate(`/About/${pop.id}`,{state:{id:pop.id}})} className="relative mx-3 aspect-video  rounded-xl overflow-hidden shadow-md shadow-[#f6f7ff3c] mb-4"id="maindiv">
            <img 
            ...
            />
             ...
             <div className="absolute inset-0 p-3 flex items-end bg-gradient-to-t from-black via-transparent" id="hidetitle">
              <h2 className="text-slate-300 text-xl">{pop.original_title}</h2>
            </div>
