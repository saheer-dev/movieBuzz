  ...
  return (
    <div className=" p-16 grid grid-cols-4 gap-36 bg-black">
        ...
        {popular.map((pop) => (
            ...
            <h2 className="text-white text-xl">{pop.original_title}</h2>
              <h2 className="text-white text-sm">{pop.original_title}</h2>
              <h2 className="text-white text-sm">{pop.vote_average}⭐</h2>
              <h2 className="text-white text-xs">{pop.release_date}</h2>
            </div>
              ...
              <p className= "h-[10rem]  text-justify text-white text-sm ">{pop.overview}</p>
